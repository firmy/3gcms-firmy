...
<script type="text/javascript" src="/Public/Admin/setdate/WdatePicker.js"></script><script type="text/javascript" src="/Public/Admin/js/admin.js"></script><script type="text/javascript" src="/Public/Admin/js/Ajax.js"></script><script type="text/javascript" src="/Public/Admin/js/Jquery.js"></script> 
</head>
<body>
...
<td colspan="5" align=left class="admintitle">幻灯列表　[<a href="__URL__/add">添加</a>][<a href="__APP__/Clear">清理附件</a>]</td></tr>
    ...
    <td height="25" align="center"><a href="__URL__/edit/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
	...
	<tr><td bgcolor="f7f7f7" colspan="5" align="left">文章幻灯模式下当前模块操作前台无效果,如需要启用手动幻灯请移步网站配置->首页配置 里修改</td></tr>
</table>
</form>
