...
<tr> 
  <td colspan="8" align=left class="admintitle">栏目列表　[<a href="__URL__/add"><font color="#FF0000">添加栏目</font></a>] [<a href="__APP__/Fields/index"><font color="#FF0000">扩展字段管理</font></a>][<a onClick="showhelp();">操作提示</a>]</td>
</tr>
  <tr align="center"> 
 ...
 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr bgcolor="#f1f3f5" onMouseOver="this.style.backgroundColor='#EAFCD5';this.style.color='red'" onMouseOut="this.style.backgroundColor='';this.style.color=''">
    <td height="24" class="tdleft"><?php echo ($vo["space"]); ?><a href="__APP__/Article/index/typeid/<?php echo ($vo["typeid"]); ?>"><?php echo ($vo["typename"]); ?></a><font color="blue">
    ...
    <td width="23%" align="center"><a href="__URL__/edit/typeid/<?php echo ($vo["typeid"]); ?>">编辑</a> | <a href="__URL__/del/typeid/<?php echo ($vo["typeid"]); ?>" onClick="JavaScript:return confirm('删除的栏目必须无子栏目,且无文章！确定？')">删除</a>  <?php if(($vo["is_last"])  ==  "0"): ?><?php if(($vo["islink"])  !=  "1"): ?>| <a href="__URL__/show_field/typeid/<?php echo ($vo["typeid"]); ?>">字段显示</a><?php endif; ?><?php endif; ?>  |<a href='__URL__/manage_moban/typeid/<?php echo ($vo["typeid"]); ?>'>模板控制</a></td>
