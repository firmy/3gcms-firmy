...
<br><br>系统幻灯片文件夹为：__PUBLIC__/Uploads/hd/  系统LOGO文件夹为：__PUBLIC__/Uploads/logo/ 友情链接LOGO文件夹为：__PUBLIC__/Uploads/link/
  <br /><br /><input type="button" value="幻灯清理" class="bnt" onClick="if(confirm('确定要清除幻灯片中的垃圾文件?\n\n请谨慎操作！'))location.href='__URL__/clearhd';return false;" />
<input type="button" value="LOGO清理" class="bnt" onClick="if(confirm('确定要清除logo文件夹中的垃圾文件?\n\n请谨慎操作！'))location.href='__URL__/clearlogo';return false;" /> 
<input type="button" value="友链清理" class="bnt" onClick="if(confirm('确定要清除友情链接文件夹中的垃圾文件?\n\n请谨慎操作！'))location.href='__URL__/clearlink';return false;" /> 
<input type="button" value="缓存清理" class="bnt" onClick="if(confirm('点击确定开始清理系统缓存'))location.href='__URL__/clearcache';return false;" /> 
 <br /><br /><br />
</td>
</tr>
</table>
