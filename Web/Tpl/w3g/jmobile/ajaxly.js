...
function showlist(data)
{
	$('#list').html('');
		...
		$("#list").listview("refresh");
		 //输出分页信息
		P_Nums = data.getElementsByTagName("data")[0].getAttribute('P_Nums');
		var A_Nums = data.getElementsByTagName("data")[0].getAttribute('A_Nums');
		var aaa="";
		document.getElementById("pinglunym").innerHTML = aaa;
		if (P_Nums>1) {
	    	var page = data.getElementsByTagName("data")[0].getAttribute('page');
