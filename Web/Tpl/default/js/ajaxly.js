	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete") {   
		...
		for (i=0;i<xmlContent.length;i++) {  
			...
			if (Content == "没有留言") {
			    ...
			    div.innerHTML = "<div class='guestbook_note'><span>留言时间:"+PostTime+"</span><b>"+ID+"</b>楼 留言者：<font color='red'>"+Author+"</font><div class='info'>"+Content+"</div><div class='reply'>"+reContent+"</div></div><hr/>"
			}
