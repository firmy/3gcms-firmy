...
function get_mood(mood_id)
{
	...
	if (get_cookie('wkmood'+infoid+'')==''+infoid+'')
	{
		...
		url ="http://"+window.location.host+root+"/index.php?m=Mood&a=update&aid="+infoid+"&type="+mood_id+"&random=" + Math.random();
...
function remood()
{
	url ="http://"+window.location.host+root+"/index.php?m=Mood&a=index&aid="+infoid+"&random=" + Math.random();
	makeRequest(url,'return_review1','GET','');
}
...
{
	var imga = tpl+"/images/mood/pre_02.gif";
	var imgb = tpl+"/images/mood/pre_01.gif";
	var color1 = "#666666";
	var color2 = "#EB610E";
...
document.writeln("<td><img src='"+tpl+"/images/mood/0.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/1.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/2.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/3.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/4.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/5.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/6.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<td><img src='"+tpl+"/images/mood/7.gif' width=\"40\" height=\"40\"><\/td>");
document.writeln("<\/tr>");
document.writeln("<tr>");
